...
("教材","S-MZ-A01","みんなのダイブ特集号 Unityでゲームをつくろう","教材",1500,1650,"","角度・加速度センサー","","","デザインシート未掲載（表紙ID要確認）"),
...
("教材","S-MZ-A07","みんなのダイブ特集号 はじめての計測と制御","教材",1500,1650,"","","","","デザインシート未掲載"),
("教材","S-MZ-A08","みんなのダイブ特集号 はじめてのコネクター活用2025","教材",1500,1650,"","","","","デザインシート未掲載"),
("教材","S-MZ-A09","みんなのダイブ特集号 はじめてのセンサーと測定","教材",1500,1650,"4573676920300","ピックアップ:タッチセンサー","","1PkMOuoY8r_q3hQuVlPGmH4C0LseZ5841",""),
("教材","S-MZ-A10","みんなのダイブ特集号 はじめてのIoTシステム","教材",1500,1650,"","","","","デザインシート未掲載"),
...
def main():
    ...
    doc = {
        "meta": {
            ...
            "version": "v1.0", "updated": "2026-06-08",
